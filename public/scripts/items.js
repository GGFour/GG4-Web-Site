...
async function shit() {
  ...
  for (let i = 0; i < categories.length; i++) {
    ...
    await pool.query(
      `INSERT INTO item_category (name, description) VALUES ('${curr.name}', '${curr.description}');`
    );
  ...
  let user_types = [{ name: "user" }, { name: "admin" }, { name: "developer" }];
  ...
  let items = [
    ...
    },
    {
      ...
      description:
        "Upon exposure to open air, this chemical will evaporate into a freezing cloud, causing any creature that contacts it to be frozen in place",
      imgId: 59,
    },
    {
      class: 5,
    ...
    },
    {
      ...
      description:
        "This powerful liquid will course through your muscles, permanently increasing your strenght by one point and health by five",
      imgId: 61,
    },
    {
      class: 5,
      ...
      description:
        "After drinking this, your mind will become attuned to the psychic signature of distant creatures. Enabling you to sense biological presence through walls.",
      imgId: 62,
    },
    {
      class: 5,
      ...
      description:
        "Upon exposure to open air, the liquid in this flask will vaporize and instantly paralyze anyone who inhales it. They will be unable to move for sometime.",
      imgId: 66,
    },
    {
      class: 5,
      ...
      description:
        "This reagent will quickly neutralize all harmful gases in the area of effect. Drinking it will give you temporary immunity to such gases",
      imgId: 64,
    },
    {
      class: 5,
      ...
      description:
        "This powerful liquid will course through your muscles, permamently increasing your strength by one point",
      imgId: 65,
    },
    {
      class: 5,
      ...
      description:
        "Shattering this pressurized glass will cause its contents to explode into a deadly cloud of toxic gas. You might want to be careful with this one...",
      imgId: 63,
    },
    {
      class: 5,
      ...
      description:
        "Drinking this potion will render you temporarily invisible. While invisible, enemies will be unable to see you. Attacking will dispel the effect",
      imgId: 68,
    },
    {
      class: 5,
      ...
      description:
        "Drinking this curious liquid will cause you to hover in the air, able to drift effortlessly over traps. However, flames and gases fill the air and cannot be bypassed by levitation",
      imgId: 67,
    },
    {
      class: 2,
      name: "ring of haste",
      description:
        "This ring accelerates the wearers flow of time, allowing one to perform all actions a little faster.",
      imgId: 33,
    },
    {
      class: 2,
      ...
      description:
        "Wearing this ring will allow the wearer to notice hidden secrets, traps and doors.",
      imgId: 34,
    },
    {
      class: 2,
      name: "ring of power",
      description:
        "Your wands will become more powerful in the energy field that radiates from this ring.",
      imgId: 35,
    },
    {
      class: 2,
    ...
    },
    {
      ...
      description:
        "Enemies will be less likely to notice you if you wear this ring.",
      imgId: 39,
    },
    {
      class: 2,
      name: "ring of thorns",
      description:
        "Though this ring doesnt provide real thorns, an enemy that attacks you will itself be wounded by a fraction of the damage that it inflicts",
      imgId: 40,
    },
    {
      class: 1,
    ...
    },
    {
      ...
      description:
        "Its a piece of frozen raw meat. The only way to eat it is by cutting thin slices of it. This way its surprisingly good!",
      imgId: 117,
    },
    {
      class: 1,
      name: "raw meat",
      description:
        "Eating is raw wouldnt be a good idea, but cooking it could expose some beneficial effects!",
      imgId: 114,
    },
    {
      class: 1,
    ...
    },
    {
      ...
      description:
        "It looks exactly like a standard ration of food, but smaller and more expensive",
      imgId: 116,
    },
    {
      class: 1,
    ...
    },
    {
      ...
      name: "torch",
      description:
        "Its a stick with a oil-dipped cloth wrapped around at the end. Lighting it will help you to see in the dark, light up braziers and burn stumps that may be blocking a path",
      imgId: 85,
      price: 10,
    },
    {
    ...
    },
    {
      ...
      name: "bubble",
      description:
        "Its just a regular-ordinary bubble. What? Did you think that our store is only for blades and magical mumbo-jumbo?",
      imgId: 82,
      price: 5,
    },
    {
      ...
      description:
        "Upon wearing this cloak you will vanish from the naked eye, but just by vanishing doesnt mean you can escape your problems.",
      imgId: 100,
    },
    {
      class: 8,
      ...
      description:
        "Just for the price of 150 coins, win the game. BUY NOW! LIMITED TIME ONLY! EXTRA 100000+ GEMS* ON PURCHASE! ONLY COSMETIC UPGRADES*! GRAB YOUR MOMMAS WALLET NOW AND ORDER!!",
      imgId: 106,
      price: 150,
    },
  ];
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    await pool.query(
      `INSERT INTO item (name, description, category_id, game_id, inventory_id, path_to_image, price) VALUES ('${
        curr.name
      }','${curr.description}', ${curr.class}, 1, ${i + 1}, '${curr.imgId}', ${
        curr.price || curr.tier * 10 || curr.class * 10
      });\n`
    );
